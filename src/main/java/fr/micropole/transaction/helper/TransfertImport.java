...
public class TransfertImport {
    ...
    public static Category TransfertImportCategory( ImportCSVTransaction importCSVTransaction, List<Category> categories ) {
        ...
        if ( libelle.contains( "U EXPRESS" ) || libelle.contains( "MONOPRIX" ) || libelle.contains( "AUCHAN" )
                || libelle.contains( "CARREFOUR AIX" ) || libelle.contains( "PROMOCASH" )
        ...
        } else if ( libelle.contains( "AMAZON" ) || libelle.contains( "CELIO" ) || libelle.contains( "NATURE DECOUV" )
                || libelle.contains( "FETER Et RECEVO" ) || libelle.contains( "NATURE & DECOUV" ) ) {
        ...
        } else if ( libelle.contains( "THE SHAMROCK" ) || libelle.contains( "SANTONI" ) ) {
        ...
        } else if ( libelle.contains( "ORANGE" ) || libelle.contains( "SPOTIFY" ) ) {
        ...
        } else if ( libelle.contains( "FIESTA DES SUDS" ) || libelle.contains( "FRANCE BILLETVA" ) ) {
