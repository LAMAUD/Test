...
<div class="container col-lg-12 padNY" style="background-image: url('<c:url value="/resources/images/NY.jpg"/>'); background-size: 1263px 543px; color: #F05F40; ">
	<div class="col-lg-7">
		...
		<form:form action="${ createTransaction }" method="POST"
			...
			<div class="form-group">
				...
				<div class="col-lg-8">
					<form:select id="category" name="category" class="selectpicker"
						path="category.id">
	...
	<div class="ajax col-lg-5">
		...
		<label for="filtre_categorie">Filtrer par Catégorie</label> <select
			class="selectpicker" name="filtre_categorie" size="1"
			id="filtre_categorie">
