...
<div class="container col-lg-12 padNY text-center"
	...
	<form:form action="${ createCategory }" method="POST"
		...
		<div class="form-group">
			<label for="name"> <spring:message code="label.nom.categorie"
		...
		<div class="form-group">
			<label for="description"> <spring:message
					code="label.description.categorie" text="default text" /></label>
			...
			<tbody>
				<c:forEach var="category" items="${ requestScope.categories }">
					<tr>
						...
						<td class="action"><a
							href="<c:url value="/category/remove"><c:param name="id" value="${ category.id }" /></c:url>">
